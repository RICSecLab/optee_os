			...
			size_t mv_len, UsefulBuf cbor_evidence_buffer)
{
	...
	UsefulBufC cbor_evidence = { NULL, 0 };
			 ...
			 UsefulBuf buffer_for_cose)
{
	...
	UsefulBufC protected_parameter = { NULL, 0 };
	...
	tbs_payload = create_tbs(protected_parameter, NULLUsefulBufC,
